...
class _FitnessLevelScreenState extends State<FitnessLevelScreen> {
  ...
  final images = [
    "assets/images/fitness_level_beginner.png",
    "assets/images/fitness_level_intermediate.png",
    "assets/images/fitness_level_advanced.png",
  ];
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Text(what_fitness_level.tr(),
              ...
              children: [
                ...
                Container(
                  ...
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text(beginner_txt.tr()),
                      Text(advanced_txt.tr()),
                    ],
                  ),
                )
              ],
            ),
            next(context, forwardBendScreen, true, () {
